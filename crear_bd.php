...
if ($total == 0) {
    $cursosData = [
        ['HTML Básico','Aprende a estructurar la web con etiquetas, formularios y multimedia. Domina HTML5 desde cero creando tus primeras páginas profesionales.',0,3,6,'imagenes/photo_1_2026-07-09_13-18-22.jpg','Módulo 1'],
        ['CSS Básico','Dale vida y color a tus estructuras HTML. Aprende selectores, modelo de caja, flexbox, grid y a maquetar interfaces modernas y atractivas.',0,3,6,'imagenes/photo_4_2026-07-09_13-18-23.jpg','Módulo 2'],
        ['JavaScript Básico','Añade interactividad a tus sitios web. Controla el DOM, maneja eventos, trabaja con APIs y domina la lógica de programación del lado del cliente.',0,4,8,'imagenes/photo_2_2026-07-09_13-18-22.jpg','Módulo 3'],
        ['PHP Básico','Conecta tu web con el servidor. Aprende manejo de sesiones, formularios, cookies, archivos, envío de correos e integración de backend de forma segura.',0,3,6,'imagenes/photo_5_2026-07-09_13-18-23.jpg','Módulo 4'],
        ['MySQL Básico','Gestiona la información de tus usuarios. Crea bases de datos relacionales, diseña tablas, realiza consultas avanzadas y aprende a integrar todo con PHP.',0,3,6,'imagenes/photo_3_2026-07-09_13-18-22.jpg','Módulo 5'],
    ];
